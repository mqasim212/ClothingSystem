...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApply" runat="server" style="z-index: 1; left: 77px; top: 402px; position: absolute; width: 95px;" Text="Apply" OnClick="btnApply_Click" />
        <asp:Button ID="btnDisplayAll" runat="server" style="z-index: 1; left: 218px; top: 402px; position: absolute" Text="Display All" OnClick="btnDisplayAll_Click" />
